...
import FamilyInformationButton from "./FamilyInformationButton";

const BasicInformation = () => {
    const familyInformation = data.family;
        ...
        <main className="profile flex flex-col w-939 mt-5 mr-20">
            <section className="shadow-am w-full  mr-20">
                ...
                <div className="bg-db h-252 mt-5 ml-7 mb-5 mr-8">
                    ...
                    <FamilyInformationButton familyInformation={familyInformation}
